...
cat logs/$1/$2jobs.runerror | awk '{printf "bsub -q 1nd -o logs/'$1'/'$2'_%s.log -J %s < jobs/'$1'/'$2'_%s.sh\n",$7,$7,$7}' | /bin/sh
...
cat logs/$1/$2jobs.copyerror | awk '{printf "bsub -q 1nd -o logs/'$1'/'$2'_%s.log -J %s < jobs/'$1'/'$2'_%s.sh\n",$7,$7,$7}' | /bin/sh
