{
  ...
  TFile* f= TFile::Open("/xrootdfs/cms/local/meridian/EFlow/fullHistoryTree/finalTree_AlCaPhiSym_Run2012A_v6fromClusters_600M_alphaFit_newLaser.root");
  ...
  t.setLumiIntervals("readMap_AlCaPhiSym_Run2012A_v6fromClusters_600M_alphaFit_newLaser.root");
  t.applyBSCorrection=0;
  t.applyLumiCorrection=0;
  t.outFileMode=TString("RECREATE");
  t.setOutfile("beamSpotAsymm.root");  
  t.bsInfoFile=TString("/xrootdfs/cms/local/meridian/EFlow/fullHistoryTree/bsInfo_AlCaPhiSym_Run2012A_v6fromClusters_600M_alphaFit_newLaser.root");
  ...
  t1.setLumiIntervals("readMap_AlCaPhiSym_Run2012A_v6fromClusters_600M_alphaFit_newLaser.root");
  ...
  t1.bsInfoFile=TString("/xrootdfs/cms/local/meridian/EFlow/fullHistoryTree/bsInfo_AlCaPhiSym_Run2012A_v6fromClusters_600M_alphaFit_newLaser.root");
  ...
  t2.setLumiIntervals("readMap_AlCaPhiSym_Run2012A_v6fromClusters_600M_alphaFit_newLaser.root");
  ...
  t2.bsInfoFile=TString("/xrootdfs/cms/local/meridian/EFlow/fullHistoryTree/bsInfo_AlCaPhiSym_Run2012A_v6fromClusters_600M_alphaFit_newLaser.root");
