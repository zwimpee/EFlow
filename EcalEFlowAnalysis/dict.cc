//
// File generated by rootcint at Thu Dec  6 11:52:29 2012
...
namespace ROOT {
   namespace Shadow {
      ...
      #if !(defined(R__ACCESS_IN_SYMBOL) || defined(R__USE_SHADOW_CLASS))
      typedef ::KFactorsVsTime KFactorsVsTime;
      #else
      class KFactorsVsTime  {
         public:
         //friend XX;
         typedef ::pair<int,int> runInterval;
         typedef ::std::map< ::pair<int,int>,float, ::less< ::pair<int,int> >, ::allocator< ::pair<const  ::pair<int,int>,float> > > kFactorsTimeMap;
      ...
      #if !(defined(R__ACCESS_IN_SYMBOL) || defined(R__USE_SHADOW_CLASS))
      typedef ::RegionStability RegionStability;
      #else
      class RegionStability  {
         public:
         //friend XX;
         #if !(defined(R__ACCESS_IN_SYMBOL) || defined(R__USE_SHADOW_CLASS))
         typedef ::RegionStability::measurement measurement;
         #else
         class measurement  {
            public:
            //friend XX;
         ...
         vector< int > nHits_; //
         vector< float > etSum_; //
         vector< float > etSumRMS_; //
         vector< float > lc_; //
         vector< float > lcRMS_; //
         vector< float > alpha_; //
         vector< float > alphaRMS_; //
      };
      #endif
      ...
      class createHistoryPlots  :  public ::alcaPhiSym_tree_v3 {
         ...
         //friend XX;
         #if !(defined(R__ACCESS_IN_SYMBOL) || defined(R__USE_SHADOW_CLASS))
         typedef ::createHistoryPlots::bsInfo bsInfo;
         #else
         class bsInfo  {
            public:
            //friend XX;
            ...
            unsigned long nHitsEB; //
            unsigned long nHitsEE; //
         };
         #endif
         ...
         class histos  {
            ...
            float alphaSum[85][360][2]; //
            float alphaSquared[85][360][2]; //
            int counter[85][360][2]; //
         };
         #endif

         #if !(defined(R__ACCESS_IN_SYMBOL) || defined(R__USE_SHADOW_CLASS))
         typedef ::createHistoryPlots::histos_ee histos_ee;
         #else
         class histos_ee  {
            public:
            //friend XX;
            float energySum[100][100][2]; //
            float energySquared[100][100][2]; //
            float energySumA[100][100][2]; //
            float energySquaredA[100][100][2]; //
            float energySumB[100][100][2]; //
            float energySquaredB[100][100][2]; //
            float energyNoCorrSum[100][100][2]; //
            float energyNoCorrSquared[100][100][2]; //
            float energyNoCorrSumA[100][100][2]; //
            float energyNoCorrSquaredA[100][100][2]; //
            float energyNoCorrSumB[100][100][2]; //
            float energyNoCorrSquaredB[100][100][2]; //
            float lasercorrSum[100][100][2]; //
            float lasercorrSquared[100][100][2]; //
            float alphaSum[100][100][2]; //
            float alphaSquared[100][100][2]; //
            int counter[100][100][2]; //
         };
         #endif
      ...
      #if !(defined(R__ACCESS_IN_SYMBOL) || defined(R__USE_SHADOW_CLASS))
      typedef ::makeMap makeMap;
      #else
      class makeMap  :  public ::alcaPhiSym_tree_v3 {
         public:
         //friend XX;
         // To force the creation of a virtual table, throw just in case.
         virtual ~makeMap() throw() {};
         ::TString outFileName; //
      };
      #endif
...
namespace ROOT {
   void KFactorsVsTime_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void KFactorsVsTime_Dictionary();
   ...
   {
      // Make sure the shadow class has the right sizeof
      R__ASSERT(sizeof(::KFactorsVsTime) == sizeof(::ROOT::Shadow::KFactorsVsTime));
      ::KFactorsVsTime *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::KFactorsVsTime),0);
      static ::ROOT::TGenericClassInfo 
         instance("KFactorsVsTime", "./KFactorsVsTime.h", 7,
                  typeid(::KFactorsVsTime), DefineBehavior(ptr, ptr),
                  &KFactorsVsTime_ShowMembers, &KFactorsVsTime_Dictionary, isa_proxy, 4,
   ...
   // Dictionary for non-ClassDef classes
   static void KFactorsVsTime_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const ::KFactorsVsTime*)0x0)->GetClass();
   }

} // end of namespace ROOT

namespace ROOT {
   void RegionStability_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void RegionStability_Dictionary();
   ...
   {
      // Make sure the shadow class has the right sizeof
      R__ASSERT(sizeof(::RegionStability) == sizeof(::ROOT::Shadow::RegionStability));
      ::RegionStability *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::RegionStability),0);
      static ::ROOT::TGenericClassInfo 
         instance("RegionStability", "./RegionStability.h", 8,
                  typeid(::RegionStability), DefineBehavior(ptr, ptr),
                  &RegionStability_ShowMembers, &RegionStability_Dictionary, isa_proxy, 4,
   ...
   // Dictionary for non-ClassDef classes
   static void RegionStability_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const ::RegionStability*)0x0)->GetClass();
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::createHistoryPlots*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("createHistoryPlots", "./createHistoryPlots.h", 28,
...
namespace ROOT {
   void makeMap_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void makeMap_Dictionary();
   static void *new_makeMap(void *p = 0);
   static void *newArray_makeMap(Long_t size, void *p);
   static void delete_makeMap(void *p);
   static void deleteArray_makeMap(void *p);
   static void destruct_makeMap(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::makeMap*)
   {
      // Make sure the shadow class has the right sizeof
      R__ASSERT(sizeof(::makeMap) == sizeof(::ROOT::Shadow::makeMap));
      ::makeMap *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::makeMap),0);
      static ::ROOT::TGenericClassInfo 
         instance("makeMap", "./makeMap.h", 18,
                  typeid(::makeMap), DefineBehavior(ptr, ptr),
                  &makeMap_ShowMembers, &makeMap_Dictionary, isa_proxy, 4,
                  sizeof(::makeMap) );
      instance.SetNew(&new_makeMap);
      instance.SetNewArray(&newArray_makeMap);
      instance.SetDelete(&delete_makeMap);
      instance.SetDeleteArray(&deleteArray_makeMap);
      instance.SetDestructor(&destruct_makeMap);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::makeMap*)
   {
      return GenerateInitInstanceLocal((::makeMap*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::makeMap*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static void makeMap_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const ::makeMap*)0x0)->GetClass();
   }
...
namespace ROOT {
   void RegionStability_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      // Inspect the data members of an object of class RegionStability.
      typedef ::ROOT::Shadow::RegionStability ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      if (sobj) { } // Dummy usage just in case there is no datamember.

      TClass *R__cl  = ::ROOT::GenerateInitInstanceLocal((const ::RegionStability*)0x0)->GetClass();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "nHits_", (void*)&sobj->nHits_);
      R__insp.InspectMember("vector<int>", (void*)&sobj->nHits_, "nHits_.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "etSum_", (void*)&sobj->etSum_);
      R__insp.InspectMember("vector<float>", (void*)&sobj->etSum_, "etSum_.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "etSumRMS_", (void*)&sobj->etSumRMS_);
      R__insp.InspectMember("vector<float>", (void*)&sobj->etSumRMS_, "etSumRMS_.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "lc_", (void*)&sobj->lc_);
      R__insp.InspectMember("vector<float>", (void*)&sobj->lc_, "lc_.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "lcRMS_", (void*)&sobj->lcRMS_);
      R__insp.InspectMember("vector<float>", (void*)&sobj->lcRMS_, "lcRMS_.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "alpha_", (void*)&sobj->alpha_);
      R__insp.InspectMember("vector<float>", (void*)&sobj->alpha_, "alpha_.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "alphaRMS_", (void*)&sobj->alphaRMS_);
      R__insp.InspectMember("vector<float>", (void*)&sobj->alphaRMS_, "alphaRMS_.", false);
   }
...
namespace ROOT {
   ...
   static void *new_RegionStability(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) ::RegionStability : new ::RegionStability;
   }
   static void *newArray_RegionStability(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) ::RegionStability[nElements] : new ::RegionStability[nElements];
   }
   // Wrapper around operator delete
   static void delete_RegionStability(void *p) {
...
namespace ROOT {
   void KFactorsVsTime_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      // Inspect the data members of an object of class KFactorsVsTime.
      typedef ::ROOT::Shadow::KFactorsVsTime ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      if (sobj) { } // Dummy usage just in case there is no datamember.

      TClass *R__cl  = ::ROOT::GenerateInitInstanceLocal((const ::KFactorsVsTime*)0x0)->GetClass();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "ebMap_[85]", sobj->ebMap_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "ebXtalMap_[2][85][360]", sobj->ebXtalMap_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "eeMap_[39]", sobj->eeMap_);
   }
...
namespace ROOT {
   void createHistoryPlots_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      ...
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "applyBSCorrection", &sobj->applyBSCorrection);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "bsCorrectionFile", &sobj->bsCorrectionFile);
      R__insp.InspectMember(sobj->bsCorrectionFile, "bsCorrectionFile.");
...
namespace ROOT {
   void makeMap_ShowMembers(void *obj, TMemberInspector &R__insp)
   {
      // Inspect the data members of an object of class makeMap.
      typedef ::ROOT::Shadow::makeMap ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      if (sobj) { } // Dummy usage just in case there is no datamember.

      TClass *R__cl  = ::ROOT::GenerateInitInstanceLocal((const ::makeMap*)0x0)->GetClass();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "outFileName", &sobj->outFileName);
      R__insp.InspectMember(sobj->outFileName, "outFileName.");
      R__insp.GenericShowMembers("alcaPhiSym_tree_v3", ( ::alcaPhiSym_tree_v3 * )( (::makeMap*) obj ), false);
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_makeMap(void *p) {
      return  p ? ::new((::ROOT::TOperatorNewHelper*)p) ::makeMap : new ::makeMap;
   }
   static void *newArray_makeMap(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::TOperatorNewHelper*)p) ::makeMap[nElements] : new ::makeMap[nElements];
   }
   // Wrapper around operator delete
   static void delete_makeMap(void *p) {
      delete ((::makeMap*)p);
   ...
   static void destruct_makeMap(void *p) {
      typedef ::makeMap current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::makeMap
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,vector<pair<int,int> > >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,vector<pair<int,int> > >", -2, "/afs/cern.ch/cms/slc5_amd64_gcc434/lcg/root/5.27.06b-cms21/cint/cint/lib/prec_stl/map", 63,
...
namespace ROOT {
   void maplEpairlEintcOintgRcOfloatgR_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void maplEpairlEintcOintgRcOfloatgR_Dictionary();
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<pair<int,int>,float>*)
   {
      ...
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(map<pair<int,int>,float>),0);
      static ::ROOT::TGenericClassInfo 
         instance("map<pair<int,int>,float>", -2, "/afs/cern.ch/cms/slc5_amd64_gcc434/lcg/root/5.27.06b-cms21/cint/cint/lib/prec_stl/map", 63,
                  typeid(map<pair<int,int>,float>), DefineBehavior(ptr, ptr),
                  0, &maplEpairlEintcOintgRcOfloatgR_Dictionary, isa_proxy, 0,
   ...
   // Dictionary for non-ClassDef classes
   static void maplEpairlEintcOintgRcOfloatgR_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const map<pair<int,int>,float>*)0x0)->GetClass();
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<int>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<int>", -2, "/afs/cern.ch/cms/slc5_amd64_gcc434/lcg/root/5.27.06b-cms21/cint/cint/lib/prec_stl/vector", 49,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<pair<int,int> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<pair<int,int> >", -2, "/afs/cern.ch/cms/slc5_amd64_gcc434/lcg/root/5.27.06b-cms21/cint/cint/lib/prec_stl/vector", 49,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<pair<lumiIntervals::runLS,lumiIntervals::runLS> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<pair<lumiIntervals::runLS,lumiIntervals::runLS> >", -2, "/afs/cern.ch/cms/slc5_amd64_gcc434/lcg/root/5.27.06b-cms21/cint/cint/lib/prec_stl/vector", 49,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<string>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<string>", -2, "/afs/cern.ch/cms/slc5_amd64_gcc434/lcg/root/5.27.06b-cms21/cint/cint/lib/prec_stl/vector", 49,
...
/* JSON */
static int G__dict_396_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   JSON* p = NULL;
...
static int G__dict_396_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_396_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_396_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__dict_396_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__dict_396_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
{
   KFactorsVsTime* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 2
   if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
     p = new KFactorsVsTime((const char*) G__int(libp->para[0]), (bool) G__int(libp->para[1]));
   } else {
     p = new((void*) gvp) KFactorsVsTime((const char*) G__int(libp->para[0]), (bool) G__int(libp->para[1]));
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_KFactorsVsTime));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_408_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 102, (double) ((KFactorsVsTime*) G__getstructoffset())->kFactor(*(int*) G__Intref(&libp->para[0]), *(int*) G__Intref(&libp->para[1])
...

{
   KFactorsVsTime* p;
   void* tmp = (void*) G__int(libp->para[0]);
   p = new KFactorsVsTime(*(KFactorsVsTime*) tmp);
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_KFactorsVsTime));
   return(1 || funcname || hash || result7 || libp) ;
...
// automatic destructor
typedef KFactorsVsTime G__TKFactorsVsTime;
static int G__dict_408_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       delete[] (KFactorsVsTime*) soff;
     } else {
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((KFactorsVsTime*) (soff+(sizeof(KFactorsVsTime)*i)))->~G__TKFactorsVsTime();
       }
       G__setgvp((long)gvp);
     }
   } else {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       ((KFactorsVsTime*) (soff))->~G__TKFactorsVsTime();
       G__setgvp((long)gvp);
     }
   }
   G__setnull(result7);
...
{
   KFactorsVsTime* dest = (KFactorsVsTime*) G__getstructoffset();
   *dest = *(KFactorsVsTime*) libp->para[0].ref;
   const KFactorsVsTime& obj = *dest;
   result7->ref = (long) (&obj);
   result7->obj.i = (long) (&obj);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
   RegionStability* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
   if (n) {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new RegionStability[n];
     } else {
       p = new((void*) gvp) RegionStability[n];
     }
   } else {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new RegionStability;
     } else {
       p = new((void*) gvp) RegionStability;
     }
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_RegionStability));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_424_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((RegionStability*) G__getstructoffset())->addMeasurement(
*(int*) G__Intref(&libp->para[0]), *(float*) G__Floatref(&libp->para[1])
...
{
      {
         RegionStability::measurement* pobj;
         RegionStability::measurement xobj = ((RegionStability*) G__getstructoffset())->getTruncatedMeanMeasurement((float) G__double(libp->para[0]), (int) G__int(libp->para[1]));
         pobj = new RegionStability::measurement(xobj);
...

{
   RegionStability* p;
   void* tmp = (void*) G__int(libp->para[0]);
   p = new RegionStability(*(RegionStability*) tmp);
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_RegionStability));
   return(1 || funcname || hash || result7 || libp) ;
...
// automatic destructor
typedef RegionStability G__TRegionStability;
static int G__dict_424_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       delete[] (RegionStability*) soff;
     } else {
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((RegionStability*) (soff+(sizeof(RegionStability)*i)))->~G__TRegionStability();
       }
       G__setgvp((long)gvp);
     }
   } else {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       ((RegionStability*) (soff))->~G__TRegionStability();
       G__setgvp((long)gvp);
     }
   }
   G__setnull(result7);
...
{
   RegionStability* dest = (RegionStability*) G__getstructoffset();
   *dest = *(RegionStability*) libp->para[0].ref;
   const RegionStability& obj = *dest;
   result7->ref = (long) (&obj);
   result7->obj.i = (long) (&obj);
   return(1 || funcname || hash || result7 || libp) ;
}
...
/* alcaPhiSym_tree_v3 */
static int G__dict_557_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_557_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((alcaPhiSym_tree_v3*) G__getstructoffset())->Cut((Long64_t) G__Longlong(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_557_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((alcaPhiSym_tree_v3*) G__getstructoffset())->GetEntry((Long64_t) G__Longlong(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_557_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letLonglong(result7, 110, (G__int64) ((alcaPhiSym_tree_v3*) G__getstructoffset())->LoadTree((Long64_t) G__Longlong(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_557_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_557_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_557_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((alcaPhiSym_tree_v3*) G__getstructoffset())->Notify());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_557_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 1:
...
// automatic copy constructor
static int G__dict_557_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__dict_557_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__dict_557_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
/* lumiIntervals */
static int G__dict_562_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_562_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const lumiIntervals*) G__getstructoffset())->numberOfIntervals());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_562_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_562_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const lumiIntervals*) G__getstructoffset())->intervalTime((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_562_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__dict_562_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const lumiIntervals::runLS* pobj;
...
// automatic copy constructor
static int G__dict_562_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__dict_562_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__dict_562_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__dict_573_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   case 1:
     //m: 1
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new makeMap((TTree*) G__int(libp->para[0]));
     } else {
       p = new((void*) gvp) makeMap((TTree*) G__int(libp->para[0]));
     }
     break;
   case 0:
     int n = G__getaryconstruct();
     if (n) {
       if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
         ...
         p = new((void*) gvp) makeMap[n];
       }
     } else {
       if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
         p = new makeMap;
       } else {
         p = new((void*) gvp) makeMap;
       }
     }
     break;
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__dictLN_makeMap));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__dict_573_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((makeMap*) G__getstructoffset())->setOutfile((const char*) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__dict_573_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((makeMap*) (soff+(sizeof(makeMap)*i)))->~G__TmakeMap();
       }
       G__setgvp((long)gvp);
     }
   } else {
...
{
   makeMap* dest = (makeMap*) G__getstructoffset();
   *dest = *(makeMap*) libp->para[0].ref;
   const makeMap& obj = *dest;
   result7->ref = (long) (&obj);
   result7->obj.i = (long) (&obj);
   return(1 || funcname || hash || result7 || libp) ;
}
...
extern "C" void G__cpp_setup_inheritancedict() {
   ...
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__dictLN_makeMap))) {
     makeMap *G__Lderived;
     G__Lderived=(makeMap*)0x1000;
     {
       alcaPhiSym_tree_v3 *G__Lpbase=(alcaPhiSym_tree_v3*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__dictLN_makeMap),G__get_linked_tagnum(&G__dictLN_alcaPhiSym_tree_v3),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
   }
}
...
extern "C" void G__cpp_setup_typetabledict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("runInterval",117,G__get_linked_tagnum(&G__dictLN_pairlEintcOintgR),0,G__get_linked_tagnum(&G__dictLN_KFactorsVsTime));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("map<runInterval,float>",117,G__get_linked_tagnum(&G__dictLN_maplEpairlEintcOintgRcOfloatcOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOfloatgRsPgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("map<pair<int,int>,float>",117,G__get_linked_tagnum(&G__dictLN_maplEpairlEintcOintgRcOfloatcOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOfloatgRsPgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("map<pair<int,int>,float,less<pair<int,int> > >",117,G__get_linked_tagnum(&G__dictLN_maplEpairlEintcOintgRcOfloatcOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOfloatgRsPgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("kFactorsTimeMap",117,G__get_linked_tagnum(&G__dictLN_maplEpairlEintcOintgRcOfloatcOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOfloatgRsPgRsPgR),0,G__get_linked_tagnum(&G__dictLN_KFactorsVsTime));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<channel>",117,G__get_linked_tagnum(&G__dictLN_vectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__dictLN_vectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__dictLN_reverse_iteratorlEvectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__dictLN_vectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<HarnessMap::channel>",117,G__get_linked_tagnum(&G__dictLN_vectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memvarJSON(void) {
   ...
   /* KFactorsVsTime */
static void G__setup_memvarKFactorsVsTime(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__dictLN_KFactorsVsTime));
   { KFactorsVsTime *p; p=(KFactorsVsTime*)0x1000; if (p) { }
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_maplEpairlEintcOintgRcOfloatcOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOfloatgRsPgRsPgR),G__defined_typename("kFactorsTimeMap"),-1,4,"ebMap_[85]=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_maplEpairlEintcOintgRcOfloatcOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOfloatgRsPgRsPgR),G__defined_typename("kFactorsTimeMap"),-1,4,"ebXtalMap_[2][85][360]=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_maplEpairlEintcOintgRcOfloatcOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOfloatgRsPgRsPgR),G__defined_typename("kFactorsTimeMap"),-1,4,"eeMap_[39]=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
   ...
   /* RegionStability */
static void G__setup_memvarRegionStability(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__dictLN_RegionStability));
   { RegionStability *p; p=(RegionStability*)0x1000; if (p) { }
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<int>"),-1,4,"nHits_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEfloatcOallocatorlEfloatgRsPgR),G__defined_typename("vector<float>"),-1,4,"etSum_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEfloatcOallocatorlEfloatgRsPgR),G__defined_typename("vector<float>"),-1,4,"etSumRMS_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEfloatcOallocatorlEfloatgRsPgR),G__defined_typename("vector<float>"),-1,4,"lc_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEfloatcOallocatorlEfloatgRsPgR),G__defined_typename("vector<float>"),-1,4,"lcRMS_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEfloatcOallocatorlEfloatgRsPgR),G__defined_typename("vector<float>"),-1,4,"alpha_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__dictLN_vectorlEfloatcOallocatorlEfloatgRsPgR),G__defined_typename("vector<float>"),-1,4,"alphaRMS_=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memvarcreateHistoryPlots(void) {
   ...
   G__memvar_setup((void*)((long)(&p->applyBSCorrection)-(long)(p)),103,0,0,-1,-1,-1,1,"applyBSCorrection=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->bsCorrectionFile)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__dictLN_TString),-1,-1,1,"bsCorrectionFile=",0,(char*)NULL);
   ...
   /* makeMap */
static void G__setup_memvarmakeMap(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__dictLN_makeMap));
   { makeMap *p; p=(makeMap*)0x1000; if (p) { }
   G__memvar_setup((void*)((long)(&p->outFileName)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__dictLN_TString),-1,-1,1,"outFileName=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncJSON(void) {
   ...
   G__memfunc_setup("JSON",314,G__dict_396_0_1, 105, G__get_linked_tagnum(&G__dictLN_JSON), -1, 0, 1, 1, 1, 0, "C - - 10 - file", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ReadJSONFile",1078,G__dict_396_0_2, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - json", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("isGoodLS",772,G__dict_396_0_3, 103, -1, -1, 0, 2, 1, 1, 0, 
"i - - 0 - run i - - 0 - lumi", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("JSON", 314, G__dict_396_0_4, (int) ('i'), G__get_linked_tagnum(&G__dictLN_JSON), -1, 0, 1, 1, 1, 0, "u 'JSON' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~JSON", 440, G__dict_396_0_5, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_396_0_6, (int) ('u'), G__get_linked_tagnum(&G__dictLN_JSON), -1, 1, 1, 1, 1, 0, "u 'JSON' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}

static void G__setup_memfuncKFactorsVsTime(void) {
   /* KFactorsVsTime */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__dictLN_KFactorsVsTime));
   G__memfunc_setup("KFactorsVsTime",1397,G__dict_408_0_1, 105, G__get_linked_tagnum(&G__dictLN_KFactorsVsTime), -1, 0, 2, 1, 1, 0, 
"C - - 10 - file g - - 0 - kFactorsPerXtalInEB", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("kFactor",714,G__dict_408_0_2, 102, -1, -1, 0, 3, 1, 1, 0, 
"i - - 11 - det i - - 11 - ring "
"i - - 11 - run", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("kFactor",714,G__dict_408_0_3, 102, -1, -1, 0, 5, 1, 1, 0, 
"i - - 11 - det i - - 11 - sign "
"i - - 11 - ieta i - - 11 - iphi "
"i - - 11 - run", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("KFactorsVsTime", 1397, G__dict_408_0_4, (int) ('i'), G__get_linked_tagnum(&G__dictLN_KFactorsVsTime), -1, 0, 1, 1, 1, 0, "u 'KFactorsVsTime' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~KFactorsVsTime", 1523, G__dict_408_0_5, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_408_0_6, (int) ('u'), G__get_linked_tagnum(&G__dictLN_KFactorsVsTime), -1, 1, 1, 1, 1, 0, "u 'KFactorsVsTime' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}

static void G__setup_memfuncRegionStability(void) {
   /* RegionStability */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__dictLN_RegionStability));
   G__memfunc_setup("RegionStability",1561,G__dict_424_0_1, 105, G__get_linked_tagnum(&G__dictLN_RegionStability), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("addMeasurement",1455,G__dict_424_0_2, 121, -1, -1, 0, 7, 1, 1, 0, 
"i - - 11 - nHits f - - 11 - etSum "
"f - - 11 - etSumRMS f - - 11 - lc "
"f - - 11 - lcRMS f - - 11 - alpha "
"f - - 11 - alphaRMS", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("getTruncatedMeanMeasurement",2801,G__dict_424_0_3, 117, G__get_linked_tagnum(&G__dictLN_RegionStabilitycLcLmeasurement), -1, 0, 2, 1, 1, 0, 
"f - - 0 - nRMS i - - 0 - NMAXITER", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("RegionStability", 1561, G__dict_424_0_4, (int) ('i'), G__get_linked_tagnum(&G__dictLN_RegionStability), -1, 0, 1, 1, 1, 0, "u 'RegionStability' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~RegionStability", 1687, G__dict_424_0_5, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_424_0_6, (int) ('u'), G__get_linked_tagnum(&G__dictLN_RegionStability), -1, 1, 1, 1, 1, 0, "u 'RegionStability' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncalcaPhiSym_tree_v3(void) {
   ...
   G__memfunc_setup("alcaPhiSym_tree_v3",1794,G__dict_557_0_1, 105, G__get_linked_tagnum(&G__dictLN_alcaPhiSym_tree_v3), -1, 0, 1, 1, 1, 0, "U 'TTree' - 0 '0' tree", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Cut",300,G__dict_557_0_2, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "n - 'Long64_t' 0 - entry", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("GetEntry",818,G__dict_557_0_3, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "n - 'Long64_t' 0 - entry", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("LoadTree",784,G__dict_557_0_4, 110, -1, G__defined_typename("Long64_t"), 0, 1, 1, 1, 0, "n - 'Long64_t' 0 - entry", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Init",404,G__dict_557_0_5, 121, -1, -1, 0, 1, 1, 1, 0, "U 'TTree' - 0 - tree", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Loop",410,G__dict_557_0_6, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Notify",633,G__dict_557_0_7, 103, -1, G__defined_typename("Bool_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Show",417,G__dict_557_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "n - 'Long64_t' 0 '-1' entry", (char*)NULL, (void*) NULL, 1);
   // automatic copy constructor
   G__memfunc_setup("alcaPhiSym_tree_v3", 1794, G__dict_557_0_9, (int) ('i'), G__get_linked_tagnum(&G__dictLN_alcaPhiSym_tree_v3), -1, 0, 1, 1, 1, 0, "u 'alcaPhiSym_tree_v3' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~alcaPhiSym_tree_v3", 1920, G__dict_557_0_10, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_557_0_11, (int) ('u'), G__get_linked_tagnum(&G__dictLN_alcaPhiSym_tree_v3), -1, 1, 1, 1, 1, 0, "u 'alcaPhiSym_tree_v3' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfunclumiIntervals(void) {
   ...
   G__memfunc_setup("lumiIntervals",1391,G__dict_562_0_1, 105, G__get_linked_tagnum(&G__dictLN_lumiIntervals), -1, 0, 1, 1, 1, 0, "C - - 10 - file", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("numberOfIntervals",1782,G__dict_562_0_2, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("intervalNumber",1486,G__dict_562_0_3, 105, -1, -1, 0, 2, 1, 1, 8, 
"i - - 0 - run i - - 0 - ls", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("intervalTime",1268,G__dict_562_0_4, 105, -1, -1, 0, 1, 1, 1, 8, "i - - 0 - interval_index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("lsStart",749,G__dict_562_0_5, 117, G__get_linked_tagnum(&G__dictLN_lumiIntervalscLcLrunLS), -1, 0, 1, 1, 1, 8, "i - - 0 - interval_index", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("lsEnd",502,G__dict_562_0_6, 117, G__get_linked_tagnum(&G__dictLN_lumiIntervalscLcLrunLS), -1, 0, 1, 1, 1, 8, "i - - 0 - interval_index", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("lumiIntervals", 1391, G__dict_562_0_7, (int) ('i'), G__get_linked_tagnum(&G__dictLN_lumiIntervals), -1, 0, 1, 1, 1, 0, "u 'lumiIntervals' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~lumiIntervals", 1517, G__dict_562_0_8, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_562_0_9, (int) ('u'), G__get_linked_tagnum(&G__dictLN_lumiIntervals), -1, 1, 1, 1, 1, 0, "u 'lumiIntervals' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfunccreateHistoryPlots(void) {
   ...
   G__memfunc_setup("createHistoryPlots",1912,G__dict_569_0_1, 105, G__get_linked_tagnum(&G__dictLN_createHistoryPlots), -1, 0, 1, 1, 1, 0, "U 'TTree' - 0 '0' tree", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Loop",410,(G__InterfaceMethod) NULL,121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("setLumiIntervals",1691,G__dict_569_0_3, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - file", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setJSON",646,G__dict_569_0_4, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - jsonFile", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("setOutfile",1060,G__dict_569_0_5, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - jsonFile", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("createHistoryPlots", 1912, G__dict_569_0_6, (int) ('i'), G__get_linked_tagnum(&G__dictLN_createHistoryPlots), -1, 0, 1, 1, 1, 0, "u 'createHistoryPlots' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~createHistoryPlots", 2038, G__dict_569_0_7, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_569_0_8, (int) ('u'), G__get_linked_tagnum(&G__dictLN_createHistoryPlots), -1, 1, 1, 1, 1, 0, "u 'createHistoryPlots' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}

static void G__setup_memfuncmakeMap(void) {
   /* makeMap */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__dictLN_makeMap));
   G__memfunc_setup("makeMap",700,G__dict_573_0_1, 105, G__get_linked_tagnum(&G__dictLN_makeMap), -1, 0, 1, 1, 1, 0, "U 'TTree' - 0 '0' tree", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Loop",410,(G__InterfaceMethod) NULL,121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("setOutfile",1060,G__dict_573_0_3, 121, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - jsonFile", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("makeMap", 700, G__dict_573_0_4, (int) ('i'), G__get_linked_tagnum(&G__dictLN_makeMap), -1, 0, 1, 1, 1, 0, "u 'makeMap' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~makeMap", 826, G__dict_573_0_5, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__dict_573_0_6, (int) ('u'), G__get_linked_tagnum(&G__dictLN_makeMap), -1, 1, 1, 1, 1, 0, "u 'makeMap' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
G__linked_taginfo G__dictLN_KFactorsVsTime = { "KFactorsVsTime" , 99 , -1 };
G__linked_taginfo G__dictLN_maplEpairlEintcOintgRcOfloatcOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOfloatgRsPgRsPgR = { "map<pair<int,int>,float,less<pair<int,int> >,allocator<pair<const pair<int,int>,float> > >" , 99 , -1 };
G__linked_taginfo G__dictLN_vectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgR = { "vector<HarnessMap::channel,allocator<HarnessMap::channel> >" , 99 , -1 };
G__linked_taginfo G__dictLN_reverse_iteratorlEvectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<HarnessMap::channel,allocator<HarnessMap::channel> >::iterator>" , 99 , -1 };
G__linked_taginfo G__dictLN_RegionStability = { "RegionStability" , 99 , -1 };
G__linked_taginfo G__dictLN_RegionStabilitycLcLmeasurement = { "RegionStability::measurement" , 115 , -1 };
...
G__linked_taginfo G__dictLN_makeMap = { "makeMap" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtabledict() {
  ...
  G__dictLN_KFactorsVsTime.tagnum = -1 ;
  G__dictLN_maplEpairlEintcOintgRcOfloatcOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOfloatgRsPgRsPgR.tagnum = -1 ;
  G__dictLN_vectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgR.tagnum = -1 ;
  G__dictLN_reverse_iteratorlEvectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgRcLcLiteratorgR.tagnum = -1 ;
  G__dictLN_RegionStability.tagnum = -1 ;
  G__dictLN_RegionStabilitycLcLmeasurement.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtabledict() {
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__dictLN_KFactorsVsTime),sizeof(KFactorsVsTime),-1,294912,(char*)NULL,G__setup_memvarKFactorsVsTime,G__setup_memfuncKFactorsVsTime);
   G__get_linked_tagnum_fwd(&G__dictLN_maplEpairlEintcOintgRcOfloatcOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOfloatgRsPgRsPgR);
   G__get_linked_tagnum_fwd(&G__dictLN_vectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgR);
   G__get_linked_tagnum_fwd(&G__dictLN_reverse_iteratorlEvectorlEHarnessMapcLcLchannelcOallocatorlEHarnessMapcLcLchannelgRsPgRcLcLiteratorgR);
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__dictLN_RegionStability),sizeof(RegionStability),-1,262400,(char*)NULL,G__setup_memvarRegionStability,G__setup_memfuncRegionStability);
   G__get_linked_tagnum_fwd(&G__dictLN_RegionStabilitycLcLmeasurement);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__dictLN_makeMap),sizeof(makeMap),-1,263424,(char*)NULL,G__setup_memvarmakeMap,G__setup_memfuncmakeMap);
}
